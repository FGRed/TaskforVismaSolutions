...
public static void main(String[] args) {
	...
	do {
		...
		try {
			...
			String MachineCodeBankNumber = 	banc.fTurnIntoMachineCode(sSimpleBankNumber,banc.fCheckBank(sSimpleBankNumber));			System.out.println("Given bank number in machine code: "+MachineCodeBankNumber);
